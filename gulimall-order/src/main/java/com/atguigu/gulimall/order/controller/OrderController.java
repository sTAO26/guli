...
public class OrderController {
     ...
     * 根据用户id查询商品购买次数
     */
    @GetMapping(value = "/getBuyTime/{memberid}")
    @ResponseBody
    public R getBuytime(@PathVariable("memberid") Long memberid){


//        Object o = orderService.getBuytime(memberid);
        List<BuyTimeTO> list = orderService.getBuytime(memberid);
